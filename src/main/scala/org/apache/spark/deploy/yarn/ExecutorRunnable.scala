...
private[yarn] class ExecutorRunnable(
  ...
  // NodeManager Client (连接 NodeManager 的客户端)
  ...
  def run(): Unit = {
    ...
    // 创建 NMClient (连接 NodeManager 的客户端)
  ...
  def startContainer(): java.util.Map[String, ByteBuffer] = {
    ...
    // 准备指令
    // 其中部分指令为: /bin/java org.apache.spark.executor.YarnCoarseGrainedExecutorBackend
    val commands = prepareCommand()
    ...
    // 将启动请求发送到 ContainerManager
    try {
      // 通过 NMClient (连接 NodeManager 的客户端) 向指定的 NodeManager 启动容器
      // 执行 commands 指令, 其中部分指令为: /bin/java org.apache.spark.executor.YarnCoarseGrainedExecutorBackend
  ...
  private def prepareCommand(): List[String] = {
    ...
    */
    ...
    // 部分指令为: /bin/java org.apache.spark.executor.YarnCoarseGrainedExecutorBackend
